...
# Create S3 bucket
resource "aws_s3_bucket" "waleed_spacedata_bucket" {
...
resource "aws_s3_bucket_acl" "s3_waleed_spacedata_bucket_acl" {
  bucket = aws_s3_bucket.waleed_spacedata_bucket.id
  acl    = "private"
}
